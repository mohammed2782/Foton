...
export class ReservationPage extends  Component <{}> {
	...
	async _contactSend(){
		...
		var custEmail = this.state.custEmail;
		...
		if (allGood){
			...
			const result = await api.makeAppointment(this.state.zuid, custName, custHP, custEmail, brand, dateTime, msg,state, this.state.regid,'EN'  );
			console.log(result);
				...
				<KeyboardAwareScrollView keyboardShouldPersistTaps={"always"} >
					<TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
						<View style={{flexDirection:"column" , flex:1 , justifyContent:"flex-start"}}>
							<View style={{flexDirection : "row" ,marginTop:20, flex:1,marginLeft:20}}>
								<View style={{flex:0.5}}/>
							...
							{ (!this.state.makeReservationMode && this.state.haveReservations)?
								...
								<View style={{flex:6 , marginLeft:20,paddingTop:20, marginRight:20}}>
									<View style={{flex:1,marginBottom:20,}}>
										<Text style={{color:"white",fontSize:17,fontWeight:"700"}}>Schedule Test Drive</Text>
									</View>
									<Form style={styles.form}>
										...
										<View style={styles.formRow} >
											...
											<View style={{flex:4}}>
												<Input
													...
													name = "custHP" placeholder="Phone number" value = {this.state.custHP}
										...
										<View style={{marginLeft:0,marginRight:10,flexDirection : "row" ,alignItems:"flex-start", justifyContent:"flex-start" , alignItems:"flex-start", flex:1 }}>
											<View style={{flex:2, paddingRight : 5 , marginBottom:0,justifyContent:"flex-end",alignItems:"flex-end",}}>
												<Text style={{color:"white",fontSize:10}}>Select date and time</Text>
												<Text style={{color:"white",fontSize:10}}>Sat - Thu</Text>
										...
										<View style={styles.formRow,{marginBottom:10,alignItems:"flex-start",flexDirection:"row",justifyContent:"center"}}>
											...
											<View style={{flex:2,alignItems:"center",justifyContent:"center"}}>
													...
													onPress={() =>	
															...
															buttonIndex => {
																if (this.state.brandFilter[buttonIndex].code =='CNCL'){
																	this.setState({brand:"MODEL", brandChoice:null});
																}else{
												...
												>
													<Text style={{color:"white",fontSize:11, paddingLeft:0,paddingRight:0,marginRight:15,marginLeft:15}}>{this.state.brand}</Text>
											...
											<View style={{flex:2,alignItems:"center",justifyContent:"center"}}>
												...
												>
													<Text style={{color:"white",fontSize:11, paddingLeft:0,paddingRight:0,marginRight:15,marginLeft:15}}>{this.state.state}</Text>
													<Icon style={{color:"white",fontSize:13,marginLeft:5,marginRight:5}} type="FontAwesome" active name="angle-down" />
												</Button>
											</View>
...
const styles = StyleSheet.create(
	{
		...
		actionBrand : {flex:1,width:"90%",backgroundColor:"#2b4c7d",height:40,alignSelf:"center",borderRadius:5,alignSelf:"center",paddingTop:0,paddingBottom:0},
