			...
			<Container style={{backgroundColor:"#3b5998"}}>
				...
				<Image source={drawerCover} style={styles.drawerCover} />
				 ...
				 <FlatList
					...
					renderItem={({item}) =>
						<LinearGradient colors={["#090f17", "transparent"]} start={{x:0, y:0.5}} end={{x:0.85, y:0.5}}
						...
						<ListItem
							...
							style = {{flex:1,flexDirection:"column",alignItems:"flex-start",paddingBottom:0,marginLeft:0,paddingTop:0,paddingRight:0 }}
						>
							<View
								style={{paddingTop:14,paddingBottom:14,paddingLeft:5,flex:1}}>
