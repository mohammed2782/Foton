		...
		return (
				<ImageBackground style={styles.backgroundImage}
					...
					<View style={{flexDirection:"column" , flex:1 , justifyContent:"flex-start"}}>
						...
						<View style={{flex:0.5,marginTop:5,paddingBottom:5,marginLeft:25,justifyContent : "flex-start", alignItems:"flex-start"}}>
							
							<Text style = {{color:'white', fontSize:20, fontWeight:"700", fontFamily:'Futura Md BT Bold'}}>
								{car.carName}
							</Text>
							<Image	source = {require ('../../img/silverline.png')} 
							style ={{resizeMode:"center",height:2,width:"30%",}}/>
										...
										<View style={styles.contentContainer}>	
											<Tabs 
												...
												<Tab 
													...
													style={{backgroundColor:"transparent",borderLeftColor:"rgb(124, 136, 155)",borderLeftWidth:2}}
												>
