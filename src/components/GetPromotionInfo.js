				...
				<View style={{flexDirection:"column" , flex:1 , justifyContent:"flex-start"}}>
					...
					<View style={{flexDirection : "row" , justifyContent:"flex-start" , alignItems:"center", flex:1,
						...
						<Text style={{fontFamily:"Franklin Gothic Book Regular" , fontSize:15, fontWeight:"bold" ,color:"white"}}>
							Get Promotion, Code: {this.props.navigation.state.params.promoCode}
						</Text>
								...
								<ImageBackground source={require('../../img/mileage/button.png')}
									...
									<TouchableHighlight onPress={()=> {this._setCustomerInfoForPromotion();}}
									 style={{flex:1,height:50,alignItems:"center",justifyContent:"center"}}>
										<Text style={{fontSize:16,color:"white",textAlign:"center",padding:10,}}>Get Promotion</Text>
									</TouchableHighlight>
								</ImageBackground>
...
const styles = StyleSheet.create(
	{
		...
		labelStyle : {fontFamily:"Franklin Gothic Book Regular" , fontSize:13 ,color:"white" , paddingRight : 10 , marginBottom:10},
