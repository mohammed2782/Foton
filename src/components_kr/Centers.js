...
import api from '../api/api.js';
	...
	export  class Centers_kr extends Component <{}> {
		constructor (props){
			super(props)
			this.state = { 
				currentTab: 1 ,
	...
	return (
		<ImageBackground style={styles.backgroundImage}
			...
			<View style={{flexDirection:"column" , flex:1 , justifyContent:"flex-start"}}>
				<View style={{flexDirection : "row-reverse" ,marginTop:15, flex:1,paddingLeft:0}}>
					<View style={{flex:0.5 }}/>
				...
				<View style={{flex:11, marginTop:5 , marginLeft:20 , marginRight:20}}>
					<Tabs 
					...
					initialPage={this.state.currentTab} onChangeTab={({ i }) => this.setState({ currentTab: i })}>
						<Tab 
							...
							style={{backgroundColor:"transparent",borderRightColor:"rgb(124, 136, 155)",borderLeftWidth:0}}
						>
							<ShowRoomTab navigation = {this.props.navigation}/>
						</Tab>
						<Tab 
							heading="سه‌نته‌ری خزمه‌تگوزاری"
							tabStyle= {styles.inActiveTab} 
							textStyle={{color: '#D3D3D3' , fontSize:13}} 
							activeTabStyle={styles.activeTab}  
							activeTextStyle={{color:"white", fontSize:13}}
	...
	const styles = StyleSheet.create(
		{
			...
			activeTab :{backgroundColor:"rgb(12,19,26)", borderLeftColor:"transparent" , 
				borderTopRightRadius:0,paddingLeft:0,paddingRight:0, borderTopLeftRadius:0, borderRightColor:"rgb(124, 136, 155)",borderRightWidth:2,
