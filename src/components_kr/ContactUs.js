...
export class ContactUs_kr extends  Component <{}> {
	constructor(props) {
		super(props);
					...
					<View style={{flexDirection : "row-reverse" ,height:"12%",marginTop:20,alignItems:"flex-start", paddingLeft:0}}>
						<View style={{flex:2, justifyContent : "flex-start", alignItems:"center"}}>
							<Button	transparent onPress={() => this.props.navigation.goBack()}>
								...
								<Text style={{color:"white"}}>گه‌ڕانه‌وه‌</Text>
									...
									<ImageBackground source={require('../../img/inner/send_button.png')}
										...
										<TouchableHighlight onPress={()=> {this._contactSend();}} 
										 style={{flex:1,height:50,alignItems:"center",justifyContent:"center"}}>
											<Text style={{color:"white",textAlign:"center",paddingBottom:10}}>بنێره</Text>
										</TouchableHighlight>
									</ImageBackground>
								</View>
								<View style={{flex:0.5}} />
...
const styles = StyleSheet.create(
	{
		...
		textInputStyle :{ height:40,textAlign:"right" ,borderColor: 'gray',backgroundColor :"#FFF", borderWidth: 1, flex:1 , fontSize :12 , paddingTop:10 ,
