...
export class PromoItem extends Component {
	...
	getTitle (promo){
		...
		//alert (s);
		return (<View><Text style={styles.endAtTitle}>به‌رده‌وامه‌ تاکو {promo.validUntil}</Text>
				<Text style={styles.promoCode}>کۆدی ئۆفه‌ر {promo.promoCode}</Text></View>);
	}
  render() {
			...
			<View style={{flexDirection : "row" , justifyContent:"center" , alignItems:"center", flex:1}}>
				...
				<View style={{flex:4}}>
					<ImageBackground source={require('../../img/mileage/button.png')}
						...
						this.props.navigation.navigate("GetPromotionInfo_kr",{promoId : this.props.promo.promoid, promoCode:this.props.promo.promoCode})}
						 style={{flex:1,height:50,alignItems:"center",justifyContent:"center"}}>
							<Text style={{fontSize:16,color:"white",textAlign:"center",padding:10,}}>وه‌رکرتنی ئوفه‌ر</Text>
						</TouchableHighlight>
					</ImageBackground>
				</View>
				<View style={{flex:0.5}}/>
