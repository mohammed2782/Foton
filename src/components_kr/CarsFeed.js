...
import {
  ...
  ListItem
	...
	export  class CarsFeed_kr extends Component <{}> {
		constructor (props){
			super(props);
			//alert("this is const");
			this.state ={
		...
		async componentDidMount(){
			//alert("this is json1 ");
			const carsList = await api.fetchCarList('kr');
			...
			return (
				<ImageBackground style={styles.backgroundImage}
					...
					<View style={{flexDirection:"column" , flex:1 , justifyContent:"flex-start"}}>
						<View style={{flexDirection : "row-reverse" ,marginTop:15, flex:1,
							paddingLeft:0}}>
							<View style={{flex:0.5 }}/>
						...
						<View style={{flex:0.3,marginTop:5,paddingBottom:5,marginRight:25,justifyContent : "center", alignItems:"flex-end"}}>
