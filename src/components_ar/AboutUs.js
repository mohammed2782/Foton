...
export class AboutUs_ar extends Component {
	//fetchAboutUs
	constructor (props){
			super(props);
			//alert("this is const");
	...
	async componentDidMount(){
			//alert("this is json1 ");
			const aboutUsJSON = await api.fetchAboutUs('AR');
...
render() {
	...
	<ImageBackground style={styles.backgroundImage}
		...
		<View style={{flex:1}}> 
			<View style={{flexDirection : "row-reverse" ,marginTop:15, flex:1.1,paddingLeft:0}}>
				<View style={{flex:0.5 }}/>
